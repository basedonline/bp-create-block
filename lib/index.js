...
program
   ...
   .action(() => {
      console.log('⚠️  Warning: wp-lemon-create is deprecated. Please use "npx wp-lemon block reuse" instead. ⚠️ \n');
...
program
   ...
   .action(() => {
      console.log('⚠️  Warning: wp-lemon-create is deprecated. Please use "npx wp-lemon blocks update" instead. ⚠️ \n');
